...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/jellyfishVideo.mkv"));
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/Jelly1.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/jelly2.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/Jelly3.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
